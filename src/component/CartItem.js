                ...
                <th scope="row" className="border-0">
                    <div className="p-2">
                        ...
                        <div className="ml-3 d-inline-block align-middle">
                            <h5 className="mb-0"> <a href="#" className="text-dark d-inline-block align-middle">Hot Ramen</a></h5><span className="text-muted font-weight-normal font-italic d-block">Category: Noodle</span>
                        </div>
                    </div>
                </th>
