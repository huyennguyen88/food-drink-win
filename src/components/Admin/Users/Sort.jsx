            ...
            <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <div className="dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                        ...
                        <li onClick={()=> this.onClick('email',1)}>
                            <a 
                                role="button" 
                                className={sortProductType.by === "email" && sortProductType.value === 1 ? "sort_selected" : ""}
                            >
                                <span className="fa fa-sort-alpha-desc pr-5">Email A-Z</span>
                            </a>
                        </li>
                        <li onClick={()=> this.onClick('email',-1)}>
                            <a 
                                ...
                                className={sortProductType.by === "email" && sortProductType. value === -1 ? "sort_selected" : ""}
                            >
                                <span className="fa fa-sort-alpha-desc pr-5">Email Z-A </span>
                            </a>
                        </li>
                    </ul>
                </div>
